...
path_directory_files_datas_to_db = os.path.join(cwd, directory_data_db)

path_directory_file_db = os.path.join(path_directory_db, name_db)
path_directory_file_excel = os.path.join(path_directory_db, name_db)
...
if not os.path.exists(path_directory_files_datas_to_db):
  os.makedirs(path_directory_files_datas_to_db)
